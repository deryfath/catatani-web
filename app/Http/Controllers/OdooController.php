...
class OdooController extends Controller {
	...
	public function getProduct()
	{
        ...
        $models = RipcordBase::client($this->url."/xmlrpc/2/object");
        $product = $models->execute_kw($this->db, $this->uid, $this->password,'product.product', 'search_read',array(),array('fields'=>array('name', 'seller_ids','qty_available','image_medium','type','x_kategori_produk')));
